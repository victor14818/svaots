...
<style>
    ...
    <div>
	    <center><h3>Tareas disponibles</h3><hr></center>
		<br>
			...
			<table class="table">
				...
				@foreach($listaProyectos as $proyecto)
					<tr>
						...
						<td>
							{{ Form::open([ 'url' => 'nvot', 'id' => trim(strtolower($proyecto->name)) ]) }}
								{{ Form::token() }}
								{{ Form::hidden('project_id',$proyecto->id) }}
								{{ Form::hidden('project_name',$proyecto->name) }}
								{{ Form::hidden('project_author',$proyecto->author) }}
